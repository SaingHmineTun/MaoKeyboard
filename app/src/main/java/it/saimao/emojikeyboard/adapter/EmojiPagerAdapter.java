...
import it.saimao.emojikeyboard.constants.EmojiIcons;
import it.saimao.emojikeyboard.constants.EmojiTexts;
import it.saimao.emojikeyboard.constants.Emojione_EmojiIcons;
import it.saimao.emojikeyboard.view.KeyboardSinglePageView;

public class EmojiPagerAdapter extends PagerAdapter {

    private final String[] TITLES = {
            // Hide Recent Tab for it doesn't work well for the moment
//            "recent",
            "people",
            "things",
            "nature",
