...
import it.saimao.tmktaikeyboard.zawgyidetector.ZawgyiDetector;
...
public class MaoDetector {
    ...
    public static boolean isShanLanguage(String selectedText2) {
        return isShanUnicode(selectedText2) || isShanZawgyi(selectedText2);
    }
}
