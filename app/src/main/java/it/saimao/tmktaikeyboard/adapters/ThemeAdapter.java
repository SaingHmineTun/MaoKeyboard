    ...
    private void setThemeBackground(ThemeViewHolder holder, int position) {
        switch (position) {
            ...
            case 1: // Green theme
                ...
                break;
            case 2: // Blue theme
                holder.binding.flThemeItem.setBackgroundColor(context.getResources().getColor(R.color.key_primary_glow));
                holder.binding.kpvTheme.setBackgroundColor(context.getResources().getColor(R.color.key_primary_glow));
                break;
            case 3: // Sunset theme
                holder.binding.flThemeItem.setBackgroundColor(context.getResources().getColor(R.color.key_sunset_glow));
                holder.binding.kpvTheme.setBackgroundColor(context.getResources().getColor(R.color.key_sunset_glow));
                break;
            case 4: // Gold theme
                holder.binding.flThemeItem.setBackgroundColor(context.getResources().getColor(R.color.key_gold_glow));
            ...
            case 5: // Pink theme
                ...
                break;
            case 6: // Violet theme
                holder.binding.flThemeItem.setBackgroundColor(context.getResources().getColor(R.color.key_violet_glow));
                holder.binding.kpvTheme.setBackgroundColor(context.getResources().getColor(R.color.key_violet_glow));
                break;
            case 7: // Scarlet theme
                holder.binding.flThemeItem.setBackgroundColor(context.getResources().getColor(R.color.key_scarlet_glow));
                holder.binding.kpvTheme.setBackgroundColor(context.getResources().getColor(R.color.key_scarlet_glow));
                break;
            case 8: // Neon theme
                holder.binding.flThemeItem.setBackgroundColor(context.getResources().getColor(R.color.key_neon));
                holder.binding.kpvTheme.setBackgroundColor(context.getResources().getColor(R.color.key_neon));
                break;
            case 9: // Custom theme
                holder.binding.flThemeItem.setBackgroundColor(context.getResources().getColor(android.R.color.transparent));
                holder.binding.kpvTheme.setBackgroundColor(context.getResources().getColor(android.R.color.transparent));
                break;
            default:
